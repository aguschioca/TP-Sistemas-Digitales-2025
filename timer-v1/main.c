...
#define CVERDEB 1
// Cantidad de interrupciones que hay en 15000 ms (0.06667 Hz) (15000 ms / 100 ms = 150)
#define CVERDEA 150
/* USER CODE END PD */
...
volatile uint8_t cntVerdeA1 = 0;
volatile uint8_t cntVerdeA2 = 0;
/* USER CODE END PV */
...
if (2 == cntVerdeA2){
HAL_GPIO_TogglePin(verdeA_GPIO_Port, verdeA_Pin);
cntVerdeA1 = 0;
cntVerdeA2 = 0;
}
}
