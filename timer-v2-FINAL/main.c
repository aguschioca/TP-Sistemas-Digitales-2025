...
#define TROJOA 1000
// Cantidad de interrupciones que hay en 500 ms ( 2 Hz) (500 ms / 100 ms = 5)
#define CROJOB 5
// Cantidad de interrupciones que hay en 200 ms ( 5 Hz) (200 ms / 100 ms = 2)
#define CAMARILLOB 2
// Cantidad de interrupciones que hay en 100 ms (10 Hz) (100 ms / 100 ms = 1)
#define CVERDEB 1

// Cantidad de interrupciones que hay en 15000 ms (0.03334 Hz) (15000 ms / 100 ms = 150)
// Tomando como referencia CROJOB, cuyo estado cambia cada 500ms,
// para conseguir 15000ms se necesitan 30 cambios ROJOB (15000/500=30)
#define CVERDEA 30
...
// Contador de interrupciones para conmutar LED verde A
volatile uint8_t cntVerdeA = 0;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, rojoA_Pin|verdeA_Pin|verdeB_Pin|rojoB_Pin
                          |LD5_Pin|amarilloB_Pin|Audio_RST_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : rojoA_Pin verdeA_Pin verdeB_Pin rojoB_Pin
                           LD5_Pin amarilloB_Pin Audio_RST_Pin */
  GPIO_InitStruct.Pin = rojoA_Pin|verdeA_Pin|verdeB_Pin|rojoB_Pin
                          |LD5_Pin|amarilloB_Pin|Audio_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
HAL_GPIO_TogglePin(rojoB_GPIO_Port, rojoB_Pin);
cntRojoB = 0;
cntVerdeA++; //aca suma el contador de verde A
}
if (CVERDEA <= cntVerdeA){
HAL_GPIO_TogglePin(verdeA_GPIO_Port, verdeA_Pin); //toggle de verde A
cntVerdeA = 0;
}
}
