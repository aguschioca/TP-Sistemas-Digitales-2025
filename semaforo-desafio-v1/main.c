...
/* USER CODE BEGIN PFP */
bool VerificarPedido1(void); // Determinar si el botón fue pulsado
bool VerificarPedido2(void); // Determinar si el botón fue pulsado
bool VerificarPedido3(void); // Determinar si el botón fue pulsado
/* USER CODE END PFP */
